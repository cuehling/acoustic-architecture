...
### 1. Initialization ProtocolThe constructor must accept these specific arguments to integrate with the grid system:Pythondef __init__(self, nx, ny, spacing, metadata):
...
- Files must be Mono .wav format.Sample Rate: The processor uses the metadata from the file (e.g., 16000Hz or 44100Hz) to calculate the time_step.
